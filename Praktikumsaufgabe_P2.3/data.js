...
(function (P2_3) {
    //Blume
    P2_3.flowers = new Array;
    //Sonnenblume
    let flower1 = { context: P2_3.canvasf1.getContext("2d"), name: "Sonnenblume", color: "yellow" };
    ...
    flower1.context.fill();
    flower1.context.closePath();
    P2_3.flowers.push(flower1);
    //Rose
    let flower2 = { context: P2_3.canvasf2.getContext("2d"), name: "Rose", color: "red" };
    ...
    P2_3.flowers.push(flower2);
    //Knospe
    let flower3 = { context: P2_3.canvasf3.getContext("2d"), name: "Knospe", color: "green" };
    ...
    P2_3.flowers.push(flower3);
    //Stiel
    P2_3.stems = new Array;
    //Gerade
    let stem1 = { context: P2_3.canvass1.getContext("2d"), name: "gerade", color: "green", width: 40, height: 600 };
    stem1.context.fillStyle = stem1.color;
    stem1.context.fillRect(230, 150, stem1.width, stem1.height);
    P2_3.stems.push(stem1);
    //Blätter
    let stem2 = { context: P2_3.canvass2.getContext("2d"), name: "Blätter", color: "limegreen", width: 20, height: 500 };
    ...
    P2_3.stems.push(stem2);
    //Stacheln
    let stem3 = { context: P2_3.canvass3.getContext("2d"), name: "Stacheln", color: "darkgreen", width: 10, height: 400 };
    ...
    P2_3.stems.push(stem3);
    //Topf
    P2_3.pots = new Array;
    //Keramik
    let pot1 = { context: P2_3.canvasp1.getContext("2d"), name: "Keramik", color: "brown" };
    ...
    P2_3.pots.push(pot1);
    //Eimer
    let pot2 = { context: P2_3.canvasp2.getContext("2d"), name: "Eimer", color: "silver" };
    ...
    P2_3.pots.push(pot2);
    //Vase
    let pot3 = { context: P2_3.canvasp3.getContext("2d"), name: "Vase", color: "blue" };
